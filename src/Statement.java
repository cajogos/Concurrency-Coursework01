/**
 * ********************************************************************* File:
 * Statement.java Author: P. Howells Contents: 7SENG007W Coursework 2019/20
 * Provides the data structure for a bank account statement. Date: 16/2/20
 */
...
public class Statement
{
	...
	public void print()
	{
		...
		{
			System.out.format("%1$-20s %2$10d  %3$10d", statement[tid].getCustomer(), statement[tid].getAmount(),
